...
function showAddOrderModal() {
    if (addOrderModal) {
        ...
        // Update title and button text based on edit mode
        const titleElement = document.querySelector('.order-form-title');
        const saveButton = document.getElementById('save-order-btn');
        
        if (window.editingOrder) {
            if (titleElement) titleElement.textContent = 'Edit Order';
            if (saveButton) saveButton.textContent = 'Save Order';
        } else {
            if (titleElement) titleElement.textContent = 'Add New Order';
            if (saveButton) saveButton.textContent = 'Add Order';
        }
